export default function card(){
  ...
  <div class="flex-none w-48 mb-10 relative z-10 before:absolute before:top-1 before:left-1 before:w-full before:h-full before:bg-teal-400">
    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRD7BjD5m7Ioaf5cCf6yMitjAGFfRnrJXJMaQ&s" alt="" class="absolute z-10 inset-0 w-full h-full object-cover rounded-lg" loading="lazy" />
  </div>
